...
MONGO_DB_URL = getenv("MONGO_DB_URL", "mongodb+srv://newbot126s:newbot126s@cluster0.4thkdrt.mongodb.net/?retryWrites=true&w=majority")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/MrProgrammer72/Power2")
